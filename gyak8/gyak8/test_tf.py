...
class WheelPathHandler(Node):
    def __init__(self):
        ...
        # Statikus transformáció létrehozása
        self.static_broadcaster = tf2_ros.StaticTransformBroadcaster(self)
        safety_transform = tf2_ros.TransformStamped()
        #eltolás robot testhez képest balra 0.5 méterrel
        ...
        # Publikálás odometry üzenetekre a kerekek és a safety frame pozíciójához
    ...
    def timer_callback(self):
        ...
        # Publikálja a kerekek és a safety frame pozícióját, itt kell különben nem mozog
    ...
    # segéd függvény az odometry üzenet publikálásához
    def publish_side_position(self, wheel_frame: str, publisher):
        
        # Ellenőrzi, hogy elérhető-e a transzformáció
        now = rclpy.time.Time()
        if self.tfBuffer.can_transform(self.target_frame, wheel_frame, time=now, timeout=rclpy.duration.Duration(seconds=0.5)):
            ...
            # Odometry üzenet létrehozása és publikálása
            odom = Odometry()
